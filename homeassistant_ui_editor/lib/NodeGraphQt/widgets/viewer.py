...
class MyRubberBand(QtWidgets.QRubberBand):
    ...
    def paintEvent(self, QPaintEvent):
        ...
        painter.setPen(QtGui.QPen(pen_color, 6))
        ###Transparent background###
        brush_color = QtGui.QColor(QtCore.Qt.transparent)
        ###Or to use solid background color###
        brush_color = QtGui.QColor(50, 50, 50, 122)
