...
class Port(object):
    ...
    def __init__(self, node, port, limited_type=None):
        self.__view = port
    ...
    def connect_to(self, port=None):
        ...
        if port.model.limited_type and self.model.limited_type != port.model.limited_type:
            raise PortError(
                "Cannot connect ports with different limited types"
            )
    ...
    def limited_type(self):
        return self.__model.limited_type

    @limited_type.setter
    def limited_type(self, limited_type):
        self.__model.limited_type = limited_type