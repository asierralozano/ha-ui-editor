...
class PortItem(QtWidgets.QGraphicsItem):
    ...
    def set_tooltip(self):
        ...
        if self.limited_type:
            tooltip += f"\ntype: {self.limited_type}"
    ...
    def _draw_triangle_port(self, painter, option, widget):
        """
        ...
        transform.translate(port_rect.center().x(), port_rect.center().y())
    ...
    def _draw_square_port(self, painter, option, widget):
        """
        Custom paint function for drawing a Triangle shaped port.
    ...
    def paint(self, painter, option, widget):
        ...
        if not self.optional:
            self._draw_square_port(painter, option, widget)
        else:
            painter.save()
    ...
    @property
    def limited_type(self):
        return self._limited_type

    @limited_type.setter
    def limited_type(self, limited_type):
        self._limited_type = limited_type
        self.set_tooltip()
